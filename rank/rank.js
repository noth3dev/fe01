const users = [
    ...
    const speedrunColorMap = [
        { threshold: 600, color: '#ff0000' }, 
        { threshold: 1200, color: '#ff7f00' }, 
        { threshold: 1800, color: '#ffff00' }, 
        { threshold: 2400, color: '#7fff00' }, 
        { threshold: 3000, color: '#00ffff' }, 
        { threshold: 3600, color: '#0000ff' }, 
        { threshold: 4200, color: '#8a2be2' }, 
